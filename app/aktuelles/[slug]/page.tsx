  ...
  return (
    <article>
      <div className="relative aspect-[21/9] w-full overflow-hidden bg-fisch-black">
        ...
        <div className="container-fisch absolute inset-x-0 bottom-0 pb-10 text-text">
          ...
          <time dateTime={artikel.date} className="mt-2 block text-sm text-text-leise">
      ...
      <div className="container-fisch max-w-2xl py-14 sm:py-20">
        <Link
          href="/aktuelles"
          className="mb-8 inline-flex items-center gap-1.5 text-sm font-semibold text-text-leise hover:text-text"
        >
          <ArrowLeft className="h-4 w-4" aria-hidden="true" />
          Zurück zu allen Neuigkeiten
        </Link>
        <div className="flex flex-col gap-4 text-text [&_h2]:mt-6 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_ol]:list-decimal [&_ol]:pl-5 [&_ul]:list-disc [&_ul]:pl-5 [&_a]:underline [&_a]:decoration-fisch-yellow [&_strong]:font-semibold [&_li]:leading-relaxed [&_p]:leading-relaxed">
