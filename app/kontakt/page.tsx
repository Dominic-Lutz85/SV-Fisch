        ...
        <div>
          ...
          <div className="mt-12 flex flex-col gap-3 rounded-2xl border border-fisch-line bg-white p-6">
            <p className="flex items-center gap-3 text-sm text-fisch-ink">
              <MapPin className="h-5 w-5 shrink-0 text-fisch-yellow-dark" aria-hidden="true" />
            ...
            >
              <Mail className="h-5 w-5 shrink-0 text-fisch-yellow-dark" aria-hidden="true" />
            ...
            <a
              ...
              className="flex items-center gap-3 text-sm text-fisch-ink hover:text-fisch-black"
            >
              <Phone className="h-5 w-5 shrink-0 text-fisch-yellow-dark" aria-hidden="true" />
