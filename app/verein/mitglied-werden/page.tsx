        ...
        <aside className="flex flex-col gap-6">
          <div className="border border-linie bg-flaeche-hoch p-6">
            ...
            <a
              ...
              download
              className="mt-4 inline-flex items-center gap-2 rounded-full border border-text px-5 py-2.5 text-sm font-bold text-text hover:bg-fisch-black hover:text-text"
            >
              <Download className="h-4 w-4" aria-hidden="true" />
              Beitrittserklärung (PDF)
            </a>
            <p className="mt-3 text-xs text-text-leise">
          ...
          <div className="border border-linie bg-flaeche-hoch p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-text-leise">
